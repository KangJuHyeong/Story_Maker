 ...
 * Use the [TopNavFragment.newInstance] factory method to
...
class TopNavFragment : Fragment() {
    ...
    lateinit var binding: FragmentTopNavBinding
...
//            Color.parseColor("#FF0000"))
    ...
    companion object {
         ...
         * @return A new instance of fragment TopNavFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            TopNavFragment().apply {
